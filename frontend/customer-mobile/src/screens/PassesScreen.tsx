...
const s = StyleSheet.create({
  ...
  ticket: { backgroundColor: colors.paper, borderRadius: 8 },
  ...
  notch: { position: 'absolute', top: 0, width: 20, height: 20, borderRadius: 10, backgroundColor: colors.concrete },
  ...
  modalCard: { width: '100%', maxWidth: 400, backgroundColor: colors.paper, borderRadius: 10, padding: 22, gap: 12, alignItems: 'center' },
  modalTitle: { fontFamily: fonts.heavy, fontSize: 22, color: colors.ink, textAlign: 'center' },
  qrBox: { width: 264, height: 264, padding: 12, backgroundColor: '#fff', borderRadius: 6, alignItems: 'center', justifyContent: 'center' },
